...
export type Normalizer<P extends PostCollectionPath> = (
  value: Record<string, any>,
) => Partial<PostCollectionRequestMap[P]>

export type PatchNormalizer<P extends PatchItemPath> = (
  normalizer: Normalizer<PostCollectionPath>,
) => (
  value: Record<string, any>,
  oldValue: Record<string, any>,
) => Partial<PatchItemRequestMap[P]>

const defaultNormalize: Normalizer<PostCollectionPath> = (
  value: Record<string, any>,
) => structuredClone(toRaw(value))

const defaultPatchNormalize: PatchNormalizer<PatchItemPath> =
  (normalize: Normalizer<PostCollectionPath>) =>
  (oldValue: Record<string, any>, value: Record<string, any>) => {
...
const NORMALIZER_MAP = {} as const as Partial<
  Record<PostCollectionPath, Normalizer<PostCollectionPath>>
>
