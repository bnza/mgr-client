...
export interface paths {
  ...
  '/api/data/samples/{parentId}/microstratigraphic_units': {
     ...
     * @description Retrieves the collection of MicrostratigraphicUnit resources.
     */
    get: operations['api_datasamples_parentIdmicrostratigraphic_units_get_collection']
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface operations {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          ...
          'text/csv': components['schemas']['ContextStratigraphicUnit.csv-context_stratigraphic_unit.stratigraphic_units.acl.read_sus.acl.read'][]
        }
      }
    }
  }
  ...
  api_datasamples_parentIdmicrostratigraphic_units_get_collection: {
    parameters: {
      query?: {
        /** @description The collection page number */
        page?: number
  ...
  api_datasample_stratigraphic_units_get_collection: {
    parameters: {
      query?: {
        ...
        'sample.year[lt]'?: string
        'sample.year[lte]'?: string
        'sample.number[between]'?: string
        'sample.number[gt]'?: string
        'sample.number[gte]'?: string
